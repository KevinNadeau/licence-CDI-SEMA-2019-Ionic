...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile_friend__ = __webpack_require__(338);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_user__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_util_util__ = __webpack_require__(222);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfileFriendPage = (function () {
    ...
    ProfileFriendPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-profile-friend',template:/*ion-inline-start:"/Users/mikechristophersylvestre/Dropbox/LyKnowledge/Formation/IMIE/CDI licence 2018-2019/licence-CDI-SEMA-2019-Ionic/src/pages/profile-friend/profile-friend.html"*/'<ion-header>\n\n    <ion-navbar>\n        <ion-title>{{ profile.fullname }}</ion-title>\n        <ion-buttons end>\n            <button (click)="goToChatRoom()" ion-button icon-only>\n        <ion-icon name="chatboxes"></ion-icon>\n      </button>\n        </ion-buttons>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding-top>\n\n    <div text-center>\n        <img id="friend-avatar" [src]="Util.pathAvatar(profile.avatar)">\n    </div>\n\n    <ion-list>\n        <ion-item-group>\n            <ion-item-divider color="light" text-center>Full name</ion-item-divider>\n            <ion-item>{{ profile.fullname }}</ion-item>\n        </ion-item-group>\n        <ion-item-group>\n            <ion-item-divider color="light" text-center>Username</ion-item-divider>\n            <ion-item>{{ profile.username }}</ion-item>\n        </ion-item-group>\n    </ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/mikechristophersylvestre/Dropbox/LyKnowledge/Formation/IMIE/CDI licence 2018-2019/licence-CDI-SEMA-2019-Ionic/src/pages/profile-friend/profile-friend.html"*/,
        }),
